...
struct Clock {
    ...
    void shift(int diff_second) {
        set_by_int(to_int()+diff_second);
    }

    private: int to_int() {
//        return second+minute*60+hour*60*60;
        int res = second+minute*60+hour*60*60;
//        cout << "DEBUG: " << to_str() << endl;
//        cout << "DEBUG: " << res << endl;
        return res;
    }

    private: void set_by_int(int i) {
//        cout << "DEBUG: " << i << endl;
        add_until_plus(i, 24*60*60);
//        cout << "DEBUG: " << i << endl;
        int s = i%60;
        int m = (i-s)/60%60;
        int h = ((i-s)/60-m)/60%24;
...
//        cout << "DEBUG: " << to_str() << endl;
    ...
    private: void add_until_plus(int& i, int n) {
        while (i<0) {
            i+=n;
        }
    }
